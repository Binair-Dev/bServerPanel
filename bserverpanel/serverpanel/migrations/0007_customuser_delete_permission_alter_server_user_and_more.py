...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('serverpanel', '0006_remove_user_groups_remove_user_user_permissions'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='server',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='serverpanel.customuser'),
        ),
        migrations.AlterField(
